export default {
  translation: {
    ...
    'agent.page.button.new.agent': 'Nuevo Agente',
    'agent.page.card.agent.new.chat': 'Nuevo Chat',
    'agent.page.card.agent.specialized': 'Especializado',
    'agent.page.card.agent.custom': 'Personalizado',

    'agent.page.chat.send': 'Mandar',
    'agent.page.chat.upload': 'Máxima cantidad de archivos: ',
    'agent.page.chat.max.size.info': 'Algunos archivos no fueron agregados porque tienen un tamaño superior a 50 MB.',

    'agent.create.page.title': 'Crear Agente',
    'agent.edit.page.title': 'Editar Agente',

    'agent.page.form.name': 'Nombre',
    'agent.page.form.debug': 'Depurar',

    'agent.page.form.back': 'Volver',
    'agent.page.form.delete': 'Eliminar',
    ...
    'agent.page.form.step.parameter.llm.config': 'Configuración de LLM',
    ...
    'agent.page.form.step.swagger.enable.swagger.message': 'Configure el Swagger',
